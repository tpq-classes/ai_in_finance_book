...
#
# Updated to avoid Keras 3 eager/graph numpy-conversion issues and
# to replace model.predict(...) with direct model calls.

import os

# Must be set BEFORE importing tensorflow/keras to force legacy Keras behavior.
